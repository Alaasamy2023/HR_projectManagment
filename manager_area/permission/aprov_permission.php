...
$sql = "update permission set approval_manager = '1'   where id='$id'";
...
echo "<script> window.open('../manager_index.php?page=permission','_self') </script>";
...
$sql = "update permission set approval_manager = '2'   where id='$id'";
...
$sql = "update permission set approval_leader = '1'   where id='$id'";
...
$sql = "update permission set approval_leader = '2'   where id='$id'";
