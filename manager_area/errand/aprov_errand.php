...
$sql = "update errand set approval_manager = '1'   where id='$id'";
...
echo "<script> window.open('../manager_index.php?page=errand','_self') </script>";
...
$sql = "update errand set approval_manager = '2'   where id='$id'";
...
$sql = "update errand set approval_leader = '1'   where id='$id'";
...
$sql = "update errand set approval_leader = '2'   where id='$id'";
