			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">حضور وانصراف موظفين القسم</h4> </div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
						<form>
							<div class="row formtype">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label>بحث</label> <a href="#" class="btn btn-success btn-block mt-0 search_button"> بحث </a> </div>
								</div>
							</div>
						</form>
					</div>
