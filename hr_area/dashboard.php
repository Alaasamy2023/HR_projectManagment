			...
			<div class="content container-fluid">
							...
							<div class="card-body">
								<div class="dash-widget-header">
									<div>
										...
										<h6 class="text-muted">الحضور اليوم</h6> </div>
				...
				<div class="row">
					<div class="col-md-12 d-flex">
						<div class="card card-table flex-fill">
							<div class="card-header">
								<h4 class="card-title float-left mt-2">متابعه</h4>
 							</div>
							<div class="card-body">
								<div class="table-responsive">
									<table class="table table-hover table-center">
										...
										<tbody>
											<tr>
												<td class="text-center">كود الموظف</td>
					...
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">الحضور والانصراف</h4> </div>
						</div>
					</div>
				</div>
				<div class="row">
						...
						<div class="table-responsive" style="box-shadow: 0 0.5em 1em -0.125em rgba(10,10,10,.1), 0 0 0 1px rgba(10,10,10,.02);">
							<table class="table table-striped custom-table mb-0">
								...
								<tbody>
									<tr>
										<td>
										<a href="hr_index.php?page=profile&id=5" class=""> <h5>Search</h5> </a>
										</td>
