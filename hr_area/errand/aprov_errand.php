...
$sql = "update errand set approval_hr = '1'   where id='$id'";
...
echo "<script> window.open('../hr_index.php?page=approval_errand','_self') </script>";
...
$sql = "update errand set approval_hr = '2'   where id='$id'";
